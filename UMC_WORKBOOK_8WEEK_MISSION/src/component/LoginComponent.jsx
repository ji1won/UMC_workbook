...
function LoginComponent() {
    ...
    const LOGIN_API_KEY = "http://localhost:3000/user/login";
    ...
    const LoginFunc = (e) => {
        ...
        setLoading(true);
        axios.get('https://api.digikala.com/v1/categories/mobile-phone/brands/apple/search/').then(function(response) {
